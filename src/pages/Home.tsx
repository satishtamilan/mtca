    ...
    <div>
      ...
      <div className="relative min-h-[600px] bg-gray-50 py-20">
        <div className="max-w-7xl mx-auto px-4 flex flex-col md:flex-row items-center">
          ...
          <a href="https://ibb.co/MkwqJGXs"><img src="https://i.ibb.co/23VXpsby/Light-the-traditional-of-Tamil-Nadu-kuththu-vilakku.jpg" alt="Light-the-traditional-of-Tamil-Nadu-kuththu-vilakku" border="0"></a><br /><a target='_blank' href='https://imgbb.com/'>how to make my facebook cover photo private</a><br />
          </div>
        </div>
      </div>
